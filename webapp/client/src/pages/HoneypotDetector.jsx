            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                <h1 className="h1" data-aos="zoom-y-out">
                  <span className="text-yellow-300">Honeypot detector</span> for all chains. Choose a chain, a dex and the token.
                </h1>
              </div>
              <form className="max-w-xl mx-auto" data-aos="zoom-y-out" data-aos-delay="150" onSubmit={handleCheck} ref={form}>
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="chain">
                      Chain
                    </label>
                    <select id="chain" className="form-select w-full text-gray-500" value={chain} onChange={onChangeChain}>
                      {chains.map((chain) => (
                ...
                <div className="flex flex-wrap -mx-3 mb-4">
                  ...
                  <div className="w-full md:w-1/2 px-3">
                    ...
                    <select id="dex" className="form-select w-full text-gray-500" value={option} onChange={onChangeOption}>
                      {options.map((option) => (
                      ...
                      {result.data && result.data.ExError ? (
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center">
                          <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                            ...
                            <p className="text-white text-lg opacity-75">{"Is this token an honeypot? " + result.isHoneypot}</p>
                            ...
                            {result.buyGas && (
                              <p className="text-white text-lg opacity-75">{"Gas used to buy the token: " + result.buyGas}</p>
                            )}
                            {result.sellGas != 0 && (
                              <p className="text-white text-lg opacity-75">{"Gas used to sell the token: " + result.sellGas}</p>
                            )}
                            {result.buyFee && (
                    ...
                    <div className="bg-green-500 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl" data-aos="zoom-y-out">
                      <div className="flex flex-col lg:flex-row justify-between items-center">
                        <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                          ...
                          {result.buyFee && <p className="text-white text-lg opacity-75">{"Buy fee: " + result.buyFee + "%"}</p>}
                          {result.sellFee && (
                            <p className="text-white text-lg opacity-75">{"Sell fee: " + result.sellFee + "%"}</p>
                          )}
                          {result.maxTokenTransaction && (
